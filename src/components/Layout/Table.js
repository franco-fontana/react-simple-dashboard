...
function GlobalFilter({
  ...
  return (
    <label className="flex gap-x-2 items-baseline">
      ...
      <input
        type="text"
        className="ml-1 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
        value={value || ""}
        onChange={(e) => {
